...
export function ResumeCard({ id, fullName, summary, positions, isOpen, onClick }: Props) {
    ...
    return (
        ...
        >
            <div className="flex flex-row items-start leading-[1.5]">
                <div className="basis-full">
                    <div className="flex flex-row items-center">
                        <H3 className={clsx("font-bold text-[1.5rem] my-0")}>{fullName} </H3>
                    </div>
                    <p className="my-2">
            ...
            >
                ...
                <Link ref={linkRef} className="w-full" to={`/cv/${id}`}>
