...
export function Score({ label, percent: percentArg, isHighlighted }: Props) {
    if (!percentArg) {
        return null
    }
            ...
            <span
                className={twMerge(
                    clsx("relative z-1", {
                        ...
                        "text-green-700": scale > 0,
                        "text-cyan-800": scale > 0.25,
                        "text-blue-800": scale > 0.5,
                        "text-indigo-800": scale > 0.75,
                    })
                )}
            >
                <span
